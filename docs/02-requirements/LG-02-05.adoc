...
// tag::TR[]
[[LG-02-05]]
==== LG 02-05 [önceki LG 1-8]: Örtük Varsayımlar Yerine Belirtik İfadeleri Tercih Etmek (R1)

Yazılım mimarları:

* varsayımları belirtik hale getirebilir ve böylece örtük varsayımlardan kaçınabilir
