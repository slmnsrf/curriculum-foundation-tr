...
// tag::TR[]
[[LG-02-01]]
==== LG 02-01: Paydaş İlgi Alanlarını Anlamak (R1,R3)

Mimarlar, paydaşları ve ilgi alanlarını, bunların yazılım mimarisi veya tasarım ve geliştirme süreci üzerindeki etkisini belirleyebilir. (R1)

Paydaş ve ilgi alanı örnekleri (R3):

|===
|Paydaş |Paydaş İlgi Alanı

| ürün yönetimi ve ürün sahipleri
| örneğin gereksinimlerin uygulanması için gereken süre

| geliştiriciler
| örneğin uygulanacak bileşenler ve arayüzler, protokoller, teknik gereksinimler ve sınır koşulları

| gereksinim mühendisleri, ürün sahipleri, iş analistleri
| örneğin gereksinimlerin karşılanması

| proje yöneticileri
| örneğin uygulama için gereken süre ve bütçe, seçilen mimari yaklaşımına ilişkin riskler

| kalite güvence ve testçiler
| örneğin bileşenlerin yalıtık testi

| operasyonlar
| örneğin sistemin işletilmesiyle ilgili altyapı gereksinimleri

|===

Yazılım mimarları, kısa vadeli ve uzun vadeli hedefler arasındaki potansiyel çatışmaları tanımlayabilirler (örneğin iş ve proje hedefleri ile mimari ve bakım yapılabilirlik hedefleri).
Bu çatışmaları çözmek için ilgili paydaşları dahil etmeleri gerektiğini anlarlar. (R1)

Mimarlar; tüm paydaş ilgi alanlarının gereksinimlere dönüştürülemeyeceğini veya dönüştürülmeyeceğini, ancak yine de dikkate alınması gerektiğini anlar. (R3)

Örneğin paydaş görüşmelerinde; mimarlar, eksik veya çelişkili gereksinimleri keşfetmek ve/veya mimari üzerindeki gereksinimleri ve sınır koşullarını doğrulamak için paydaş ilgi alanlarını kullanabilirler. (R3)
