...
| proje yöneticileri
| örneğin uygulama için gereken süre ve bütçe, seçilen mimari yaklaşımın ilişkili riskleri

| kalite güvence ve testçiler
| örneğin bileşenlerin izole testi
...
Yazılım mimarları, kısa vadeli ve uzun vadeli hedefler arasındaki potansiyel çatışmaları belirleyebilir (örneğin iş ve proje hedefleri ile mimari ve bakım yapılabilirlik hedefleri).
...
Mimarlar, paydaş ilgi alanlarını eksik veya çelişkili gereksinimleri keşfetmek ve/veya mimari üzerindeki gereksinimleri ve sınır koşullarını doğrulamak için kullanabilir, örneğin paydaş görüşmelerinde. (R3)
