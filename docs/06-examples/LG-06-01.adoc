...
// tag::TR[]
[[LG-06-01]]
==== LG 06-01 [önceki LG 5-1]: Gereksinimler, Sınır Koşulları ve Çözümler Arasındaki İlişkiyi Bilmek (R3)
Yazılım mimarlarının en az bir örnek kullanarak gereksinimler ve sınır koşulları ile seçilen çözümler arasındaki ilişkiyi tanıması ve anlaması beklenir.
