...
// tag::TR[]
[[LG-03-10]]
==== LG 03-10 [önceki LG 2-4]: Kesişimsel İlgi Alanlarını Belirlemek, Tasarlamak ve Uygulamak (R1)

Yazılım mimarları şunları yapabilir:

* {glossary_url}cross-cutting-concern[kesişimsel ilgi alanlarının] önemini açıklamak
* kesişimsel ilgi alanlarını belirlemek
* kesişimsel kavramları tasarlamak, örneğin süreğenlik, iletişim, GUI, hata işleme, eşzamanlılık, enerji verimliliği
* olası karşılıklı bağımlılıkları belirlemek ve değerlendirmek.

Yazılım mimarları, bu tür kesişimsel kavramların sistemler arasında yeniden kullanılabileceğini bilir.
