...
// tag::TR[]
[[LG-03-02]]
==== LG 03-02 [önceki LG 2-2]: Yazılım Mimarileri Tasarlamak (R1)

Yazılım mimarları şunları yapabilir:

* ne güvenlik açısından kritik ne de iş açısından kritik olan yazılım sistemleri için bilinen fonksiyonel ve kalite gereksinimlerine dayalı olarak yazılım mimarilerini tasarlamak, uygun şekilde iletmek ve belgelemek
...
* yapı taşlarının adım adım iyileştirilmesini ve belirtilmesini uygulamak
* mimari görünümleri tasarlamak, özellikle yapı taşı görünümü, çalışma zamanı görünümü ve dağıtım görünümü (bkz. <<LG-04-05>>)
* kararların ilgili kaynak kodu üzerindeki sonuçlarını açıklamak
* mimarilerin teknik ve alan ile ilgili öğelerini ayırmak ve bu kararları gerekçelendirmek
