...
* gereksinimlerin hangi ilkelerin uygulanması gerektiğini nasıl belirlediğini açıklayabilir
...
* {glossary_url}information-hiding[Information Hiding] ve {glossary_url}encapsulation[kapsülleme]
* {glossary_url}separation-of-concern[Separation of Concerns] - SoC
* yapı taşlarının gevşek, ancak işlevsel olarak yeterli, bağlılığı (R1), bkz. <<LG-03-06>>
* yüksek {glossary_url}cohesion[bağdaşıklık]
* {glossary_url}open-close-principle[Açık/kapalı ilkesi]
* arayüzler veya benzeri soyutlamalar aracılığıyla {glossary_url}dependency-inversion[Dependency Inversion Principle]
...
* tutarlılık, kavramsal bütünlük ve sağlamlığa (tür güvenliği anlamında) ulaşmanın bir yolu olarak Liskov'un yerine koyma ilkesi (R3).
