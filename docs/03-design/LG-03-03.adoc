...
// tag::TR[]
[[LG-03-03]]
==== LG 03-03 [önceki LG 2-1]: Mimari Geliştirme için Yaklaşımları ve Buluşsal Yöntemleri Seçmek ve Kullanmak (R1,R3)
Yazılım mimarları, mimari geliştirmenin temel yaklaşımlarını adlandırabilir, açıklayabilir ve kullanabilir, örneğin:

* tasarımda yukarıdan aşağıya ve aşağıdan yukarıya yaklaşımlar, bkz. <<gharbietal>>, <<starke>> (R1)
