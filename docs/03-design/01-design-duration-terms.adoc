...
=== Amaç
Bu bölüm, katılımcıların sistem bağlamının verilen sınır koşullarına saygı gösterirken paydaş gereksinimlerini karşılayacak şekilde mimari kararlar almasını sağlamayı amaçlar.
...
Ayrıca, bu bölüm kesişen ilgi alanlarının yönetimi, yazılım dağıtımının ilkeleri ve dağıtık sistemlerin zorluklarını ele alır.
