...
Yazılım mimarları, özellikle belirsizlik karşısında kararlar alındığında iterasyonların gerekliliğini anlar. Onlar:

* iteratif yaklaşımların mimari kararlar üzerindeki etkisini (riskler ve öngörülebilirlik açısından) açıklayabilir. (R1)
* iteratif olarak çalışabilir ve karar verebilir. (R1)
