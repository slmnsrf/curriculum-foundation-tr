...
Bilhassa bir ekip bünyesinde yazılım geliştirme konusunda kapsamlı pratik deneyime sahip olunması, öğrenim içeriğini anlamak ve başarılı sertifikasyon edinimi için önemli bir ön koşuldur.
...
*** _kapsam_, yani tip ve değişken bildirimi ve tanımı
** tip sistemlerinin temelleri (statik ve dinamik tipleme, jenerik veri türleri)
** yazılımda hata ve istisna işleme
** genel durum ve genel değişkenlerin potansiyel sorunları

* Temel bilgiler:
** modelleme ve soyutlama
** algoritmalar ve veri yapıları (Listeler, Ağaçlar, Özet Tablosu, Sözlük, Eşlem gibi)
...
* emirsel, bildirimsel, nesne yönelimli ve işlevsel programlamanın temelleri ve farkları
