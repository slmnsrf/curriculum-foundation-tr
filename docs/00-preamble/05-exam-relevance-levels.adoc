...
Her öğrenme hedefi için, bu öğrenme hedefinin veya alt öğelerinin sınav için önemi açıkça belirtilmiştir (aşağıdaki tabloda gösterilen R1, R2, R3 sınıflandırmasıyla).
Her öğrenme hedefi, anahtar terim ve kavramları dahil olmak üzere öğretilecek içerikleri tanımlar.
