...
Ayrıca katılımcılar, açık, doğru ve paydaşlarla ilgili dokümantasyonu sağlamak için temel mimari kararları, arayüzleri ve kesişen ilgi alanlarını dokümante etmeyi öğreneceklerdir.

=== İlgili Terimler
(Mimari) görünümler; yapılar; (teknik) kavramlar; dokümantasyon; iletişim; tanım; hedef kitlelere ve paydaş ilgi alanlarına uyum; tanım ve iletişim için yapılar ve şablonlar; sistem bağlamı; yapı taşları; yapı taşı görünümü; çalışma zamanı görünümü; dağıtım görünümü; düğüm; kanal; dağıtım yapıları; yapı taşlarının dağıtım yapılarına eşlenmesi; dağıtım yapılarının düğümlere eşlenmesi; arayüz ve tasarım kararları tanımı; UML; dokümantasyon araçları
// end::TR[]
