...
Gerekli düzeltmeleri ilgili paydaşlarla koordine etmek ve üzerinde anlaşmak.
...
* kesişen ilgi alanlarına karar vermek (örneğin kalıcılık, iletişim, GUI)
...
* mimarinin gerçekleştirilmesine ve uygulanmasına eşlik etmek; gerekirse ilgili paydaşlardan gelen geri bildirimleri mimariye entegre etmek; kaynak kodu ve yazılım mimarisinin tutarlılığını gözden geçirmek ve sağlamak
* yazılım mimarisini analiz etmek ve değerlendirmek, özellikle gereksinimlerin karşılanmasını içeren riskler açısından.
* mimari kararların sonuçlarını belirlemek, vurgulamak ve diğer paydaşlara gerekçelendirmek

Tüm görevlerde iterasyonların gerekliliğini bağımsız olarak fark etmeli ve uygun ve ilgili geri bildirim için olanakları belirtmelidirler.
