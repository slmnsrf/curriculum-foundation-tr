...
// tag::TR[]
[[LG-01-04]]
==== LG 01-04: Yazılım Mimarlarının Görev ve Sorumluluklarını Anlamak (R1)

Yazılım mimarları, gereksinimleri karşılamaktan ve çözümün mimari tasarımını oluşturmaktan sorumludur.
Kullanılan gerçek yaklaşıma veya süreç modeline bağlı olarak, bu sorumluluğu proje yönetiminin veya diğer rollerin genel proje sorumluluğuyla uyumlu hale getirmelidirler.

Yazılım mimarlarının görev ve sorumlulukları:

* gereksinimleri ve sınır koşullarını netleştirmek ve sorgulamak.
Gerekli safileştirmeleri ilgili paydaşlarla koordine etmek ve safileştirmeler üzerinde anlaşmak.
* yapı taşları arasındaki bağımlılıkları ve arayüzleri belirlerken sistemin yapı taşlarına nasıl ayrıştırılacağına karar vermek
* kesişen ilgi alanlarına karar vermek (örneğin süreğenlik, iletişim, GUI)
* yazılım mimarisini; görünümler, mimari örüntüler, kesişen ilgi alanları ve teknik konulara dayalı olarak iletmek ve belgelemek
* mimarinin gerçekleştirilmesine ve uygulanmasına eşlik etmek; gerekirse ilgili paydaşlardan gelen geri bildirimleri mimariye entegre etmek; kaynak kodunun ve yazılım mimarisinin tutarlılığını gözden geçirmek ve temin etmek
* yazılım mimarisini, bilhassa gereksinimlerin karşılanmasına etki edebilecek riskler açısından analiz etmek ve değerlendirmek
* mimari kararların sonuçlarını belirlemek, vurgulamak ve diğer paydaşlara gerekçelendirmek

Tüm görevlerde yinelemelerin gerekliliğini bağımsız olarak fark etmeli; uygun ve alakalı geri bildirimler için olanakları belirtmelidirler.
