...
Yazılım mimarları rollerini açıklayabilir.
Sistem geliştirmeye katkılarını belirli bağlama ve diğer paydaşlar ile organizasyon birimleriyle ilişkiye göre uyarlamalıdırlar, özellikle:
